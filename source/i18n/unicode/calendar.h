...
#undef ERA
     ...
     * @stable ICU 4.4
     */
    virtual UCalendarWeekdayType getDayOfWeekType(UCalendarDaysOfWeek dayOfWeek,
...
protected:
     ...
     * @internal
     */
    inline int32_t internalGet(UCalendarDateFields field, int32_t defaultValue) const {
     ...
     * @internal
     */
    virtual int64_t handleComputeMonthStart(int32_t eyear,
                                                       int32_t month,
                                                       UBool useMonth,
...
public:
     ...
     */
    static Calendar* U_EXPORT2 makeInstance(const Locale& locale, UErrorCode& status);
